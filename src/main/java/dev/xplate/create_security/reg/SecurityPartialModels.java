...
public class SecurityPartialModels {
    ...
    public static final PartialModel CHUNK_DETECTOR_CENTER = PartialModel.of(res("block/chunk_detector_center"));
    public static final PartialModel CHUNK_DETECTOR_CENTER_ALT = PartialModel.of(res("block/chunk_detector_center_no_speed"));
